...
public class EstudianteServiceImpl implements IEstudianteService{
	...
	@Override
	public Estudiante buscarPorNombreNativeQuer(String nombre) {
		// TODO Auto-generated method stub
		return this.estudianteRepo.buscarPorNombreNativeQuery(nombre);
	}

	@Override
	public Estudiante buscarPorNOmbreNativeQuerTypedNamed(String nombre) {
		// TODO Auto-generated method stub
		return this.estudianteRepo.buscarPorNOmbreNativeQueryTypedNamed(nombre);
	}

	@Override
	public List<Estudiante> buscarNombreQuerList(String nombre) {
		// TODO Auto-generated method stub
