...
public class ProyectoPaU3AqApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
	 ...
	 // System.out.println("Estudiante por nombre Query list " + this.estudianteService.buscarNombreQuerList(estudiantes.get(1).getNombre()));
	  
	  System.out.println("Lista de estudiantes obtenidos por query : " );
	  this.estudianteService.buscarNombreQuerList("Anddy").forEach(System.out::println);
